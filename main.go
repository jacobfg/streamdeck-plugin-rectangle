...
func main() {
	f, err := ioutil.TempFile("", "com.github.jacobfg.streamdeck-plugin-rectangle.log")
	if err != nil {
...
func setup(client *streamdeck.Client) {
	...
	for _, actionName := range actionsNames {
		...
		action := client.Action("com.github.jacobfg.streamdeck-plugin-rectangle." + actionName)
